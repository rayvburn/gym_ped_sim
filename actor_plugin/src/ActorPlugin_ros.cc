...
ignition::math::Vector3d ActorPlugin::CallActorVelClient(std::string actor_name_) const {
	...
	ros::ServiceClient get_vel_client = this->ros_nh_ptr->serviceClient<actor_services::GetVel>("/"+actor_name_+"/GetActorVelocity");
...
bool ActorPlugin::SetPoseCallback(actor_services::SetPose::Request& req, actor_services::SetPose::Response& res) {
